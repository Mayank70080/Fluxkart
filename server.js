...
const db = knex({
    client: 'pg',
    connection: {
        host: 'cqkuvv0gph6c738m6gp0-a.oregon-postgres.render.com',
        user: 'fluxkartusers_qecf_user',
        port: 5432,
        password: 'OR9tQYzs5NIAsIPhTO20oB6gy6EXW1bW',
        database: 'fluxkartusers_qecf',
        ssl: true
    }
})
